    ...
    stages {
        ...
        stage('SonarQube Test') {
         ...
         stage('Nexus Archieve') {
            steps {
                sh 'mvn deploy'
                nexusArtifactUploader credentialsId: 'nexus-user-credentials', groupId: 'web-app', nexusUrl: 'http://54.189.189.148:8081', nexusVersion: 'nexus2', protocol: 'http', repository: 'maven-build-repo', version: '1.0.1'
            }
        }
